      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-2">
          <div className="flex items-center justify-between">
            {/* Logo */}
            <motion.div
              className="flex items-center gap-3 cursor-pointer relative h-10 w-20"
            ...
            >
              <img
                src="/logo.png"
                alt="Nirvaha Logo"
                className="h-20 w-auto rounded-md object-contain drop-shadow-sm absolute left-0 top-1/2 -translate-y-1/2 max-w-none"
              />
              ...
              <div className="relative">
                ...
                {featuresMenuOpen && (
                  <motion.div
                    ...
                    className="absolute top-full left-0 mt-2 w-64 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200 overflow-hidden"
                  >
        ...
        >
          <div className="max-w-7xl mx-auto px-6 py-4 space-y-2">
            ...
            <div className="space-y-2">
              <div className="px-6 py-3 text-lg rounded-2xl text-teal-600">Features</div>
              {featureItems.map((item, index) => (
                <motion.button
                  key={item.id}
                  initial={{ opacity: 0, x: -20 }}
