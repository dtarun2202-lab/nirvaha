    ...
    <div className="signup-container lg:grid lg:grid-cols-12 min-h-screen lg:h-screen bg-[#FAF9F6] font-sans selection:bg-emerald-100 selection:text-emerald-900 lg:overflow-hidden">
      ...
      <div className="signup-form-side lg:col-span-7 flex items-start justify-center p-6 md:p-12 lg:p-16 overflow-y-auto h-full lg:h-screen custom-scrollbar">
        ...
        >
          ...
          {/* Social Logins */}
          <div className="social-auth-grid flex justify-center mb-6">
            <button 
              type="button"
              onClick={handleGoogleSignup}
              disabled={loading}
              className="flex items-center justify-center gap-2.5 w-full px-4 py-3 border border-zinc-200 rounded-xl bg-white hover:bg-zinc-50 text-zinc-700 font-medium text-xs md:text-sm transition-all duration-200 shadow-sm active:scale-[0.98] disabled:opacity-50"
            >
