    ...
    switch (variant) {
      case "companion":
        switch (status.toLowerCase()) {
          ...
          case "approved":
            return { label: "Approved", className: "bg-white text-black border-gray-300" };
          case "rejected":
          ...
          default:
            return { label: status, className: "bg-white text-black border-gray-300" };
        }
      case "booking":
        switch (status.toLowerCase()) {
          ...
          case "completed":
            return { label: "Completed", className: "bg-white text-black border-gray-300" };
          case "cancelled":
            return { label: "Cancelled", className: "bg-red-100 text-red-800 border-red-300" };
          case "in-progress":
            return { label: "In Progress", className: "bg-white text-black border-gray-300" };
          case "pending":
      ...
      case "user":
        switch (status.toLowerCase()) {
          case "active":
            return { label: "Active", className: "bg-white text-black border-gray-300" };
          case "suspended":
            return { label: "Suspended", className: "bg-orange-100 text-orange-800 border-orange-300" };
          case "banned":
