...
const ADS_DATA = [
  {
    ...
    alt: "Vedic Chants",
    description: "Ancient Vedic mantras and Sanskrit healing chants sourced from JioSaavn.",
    ...
    sounds: [
      {
        ...
        icon: "🔔",
        description: "Deep Tibetan bowl resonance for inner healing",
        url: "/audio/stress/Tibetan-Bowls.mp3",
      },
      {
        id: "v2",
        label: "Sacred Om Sound Bath",
        icon: "🕉️",
        description: "Immersive Om mantra vibration & sound bath",
        url: "/audio/meditation/Sacred-Sound-Bath.mp3",
      },
      {
        id: "v3",
        label: "Crystal Healing Frequencies",
        icon: "💎",
        description: "Sanskrit healing & crystal frequency meditation",
  ...
  },
  {
    ...
    link: "https://www.jiosaavn.com/featured/meditation-music/AMIgOn0VKAQ_",
    alt: "Spotify Meditation",
    description: "JioSaavn curated meditation, breathwork & deep relaxation journeys.",
    ...
    sounds: [
      ...
      },
      {
        ...
        icon: "🌬️",
        description: "Breath-focused deep relaxation & pranayama",
      ...
      },
      {
        ...
        icon: "🌙",
        description: "Sleep meditation & yoga nidra body scan",
