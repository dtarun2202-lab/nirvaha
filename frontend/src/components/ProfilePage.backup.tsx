...
export function ProfilePage() {
  ...
  const wellnessMessage = stats.wellnessScore < 30 
    ? "Let’s get started 🌱" 
    : stats.wellnessScore < 70 
    ? "You're improving 💪" 
      ...
      <div className="max-w-7xl mx-auto px-6" ref={profileRef}>
              ...
              <div className="flex-1">
                ...
                <div className="grid grid-cols-3 gap-6 mt-6">
                  <div className="bg-white/60 backdrop-blur-md rounded-3xl p-5 border border-white/60 shadow-sm text-center">
                    <div className="text-3xl font-black text-[#1B4332] mb-0.5 tracking-tighter">{stats.followers ?? 0}</div>
                    <div className="text-[10px] text-[#2D6A4F] font-black uppercase tracking-widest">Followers</div>
                  </div>
                  <div className="bg-white/60 backdrop-blur-md rounded-3xl p-5 border border-white/60 shadow-sm text-center">
                    <div className="text-3xl font-black text-[#1B4332] mb-0.5 tracking-tighter">{stats.following ?? 0}</div>
                    <div className="text-[10px] text-[#2D6A4F] font-black uppercase tracking-widest">Following</div>
                  </div>
                  <div className="bg-white/60 backdrop-blur-md rounded-3xl p-5 border border-white/60 shadow-sm text-center">
                    <div className="text-3xl font-black text-[#1B4332] mb-0.5 tracking-tighter">{stats.posts ?? 0}</div>
                    <div className="text-[10px] text-[#2D6A4F] font-black uppercase tracking-widest">Posts</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          >
            ...
            <h5 className="text-gray-800 mb-1">Practice Time</h5>
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-5xl font-bold text-[#1B4332]"><StatCounter value={Math.round((stats.totalMinutes || 0) / 60)} /></span>
              <span className="text-xl text-[#6b7280]">hours</span>
            </div>
            <p className="text-sm text-[#6b7280]">Total mindfulness journey</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-[#6b7280]">Mental gym results</p>
          </motion.div>
