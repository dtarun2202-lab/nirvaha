          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                />
                <div ref={nirvahaRef}>
                  <h3 className="text-xl font-bold bg-gradient-to-r from-gray-100 to-gray-200 bg-clip-text text-transparent">
                    NIRVAHA
                  </h3>
                </div>
              </button>
                    ...
                    >
                      {featureItems.map((item, index) => (
                        ...
                        >
                          {item.id === "meditation" ? (
                            <span
                              className="animated-gradient-text with-border font-semibold drop-shadow-sm"
                              style={{ background: "linear-gradient(135deg, #a78bfa, #818cf8, #38bdf8)" }}
                            >
            ...
            <div className="hidden lg:flex items-center gap-3">
              {user ? (
                <Link
                  ...
                  className="px-6 py-2.5 rounded-full text-white font-semibold text-sm hover:scale-105 hover:shadow-lg transition-all duration-300 border border-gray-400/30 bg-gray-600/80 backdrop-blur-sm"
                >
                  Dashboard
                </Link>
              ) : (
                <>
                  ...
                  <Link
                    to="/signup"
                    className="px-6 py-2.5 rounded-full text-white font-semibold text-sm hover:scale-105 hover:shadow-lg transition-all duration-300 bg-gradient-to-r from-gray-500 to-gray-500 shadow-md"
                  >
                    Get Started
                  </Link>
                </>
            ...
            >
              <div className="px-4 py-6 space-y-4">
                ...
                <div className="space-y-2">
                  <div className="px-4 text-xs font-semibold text-gray-200/50 uppercase tracking-wider">Features</div>
                ...
                <div className="pt-4 mt-4 border-t border-white/10 flex flex-col gap-3">
                  {user ? (
                    <button
                      ...
                      className="w-full py-3 rounded-xl text-white font-semibold bg-gray-600/80"
                    >
                      Dashboard
                    </button>
                  ) : (
                    <>
                      ...
                      <button
                        ...
                        className="w-full py-3 rounded-xl text-white font-semibold bg-gradient-to-r from-gray-500 to-gray-500"
                      >
                        Get Started
                      </button>
                    </>
